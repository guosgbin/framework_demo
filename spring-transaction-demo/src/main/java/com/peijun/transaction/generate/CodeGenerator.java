package com.peijun.transaction.generate;
...
public class CodeGenerator {
    ...
    private static final String parent = "com.peijun.transaction"; // 工程父类包名
    ...
    private static final String projectPath = System.getProperty("user.dir") + "\\spring-transaction-demo"; // 项目的目录
