...
import com.peijun.transaction.service.TransactionPropagationExample;
...
public class TransactionPropagationExampleImplTest {
    ...
    // ↑↑↑↑↑↑↑↑↑↑↑↑
    // 结论：
    // 通过这两个方法我们证明了在外围方法未开启事务的情况下Propagation.REQUIRED修饰的内部方法会新开启自己的事务，
    // 且开启的事务相互独立，互不干扰。
    // -----------------
    ...
    /**
     * 结果：张三（插入），李四（未插入）</br>
     * 外围方法开启事务，插入“张三”方法和插入“李四”方法为外围方法的子事务，插入“李四”方法抛出异常，
     * 相应的子事务回滚，异常被捕获外围方法不可知，故外围方法事务无需回滚。
     * <p>
    ...
    // ↑↑↑↑↑↑↑↑↑↑↑↑
    // ---------------
    // 结论：以上试验结果我们证明在外围方法开启事务的情况下Propagation.NESTED修饰的内部方法属于外部事务的子事务，外围主事务回滚，
